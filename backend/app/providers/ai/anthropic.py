...
Uses Claude API for story and scene generation.
"""
...
class AnthropicProvider(AIProvider):
    ...
    Uses Claude 3.5 Sonnet for story generation.
    """
    ...
    async def generate_story(
        ...
        """
        Generate a documentary-style story from a title using Claude.
    ...
    async def generate_scene_breakdown(
        ...
        """
        Break story into scenes with descriptions using Claude.
    ...
    async def generate_image_prompt(
        ...
        """
        Generate a detailed image prompt for a scene using Claude.
    ...
    async def extract_characters(
        ...
        """
        Extract character descriptions from story using Claude.
        ...
        try:
            ...
            # Parse JSON response
            characters_json = response.content[0].text
